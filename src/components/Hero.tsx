    ...
    <section aria-labelledby="hero-heading" className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 md:py-28">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-3">
              ...
              >
                <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  {/* LinkedIn dot (filled for legibility) */}
          ...
          cdiv className="flex flex-col items-center md:items-end gap-3"
            cdiv className="relative w-48 h-48 sm:w-60 sm:h-60 md:w-72 md:h-72 lg:w-80 lg:h-80"
              cImage
                src="/avatar.png"
            ...
            cp className="mt-1 inline-flex items-center gap-2 rounded-full border border-border/60 bg-muted/40 px-3 py-1.5 text-xs sm:text-sm text-foreground/90"e
              csvg
                ...
                aria-hidden="true"
              e
                ccircle cx="12" cy="12" r="9" strokeWidth="1.5" /e
                cpath
                ...
                /e
              c/svge
              cspan className="bg-gradient-to-r from-primary-600 via-accent-600 to-primary-600 bg-clip-text text-transparent font-medium"e
      ...
      cdiv className="pointer-events-none absolute inset-x-0 bottom-6 flex justify-center"e
        cdiv className="pointer-events-auto flex flex-col items-center gap-2"e
          ...
          e
            csvg className="h-5 w-5 text-foreground" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true"e
              cpath d="M6 9l6 6 6-6" strokeLinecap="round" strokeLinejoin="round" /e
            c/svge
          c/ae
          cspan className="text-xs font-medium text-muted-foreground"eView my workc/spane
        c/dive
      c/dive
    </section>
  );
