...
(self.wpRiseJsonp = self.wpRiseJsonp || []).push([
  [
    'vendors-node_modules_pnpm_articulate_design-system_1_7_3__articulate_design-system-tokens_1_2-4c25e4',
  ],
  {
    99384: (on, Ta, Yr) => {
      (Yr.r(Ta),
        Yr.d(Ta, {
          Arc: () => fi,
          ArcAbstractFlexLayouts: () => Xe,
          ArcAbstractGapSizes: () => Ra,
          ArcAbstractIconSizes: () => da,
          ArcAbstractTextLayouts: () => Ye,
          ArcAbstractTextOverflows: () => La,
          ArcAbstractTextSizes: () => Ze,
          ArcAvatar: () => wa,
          ArcAvatarColors: () => ne,
          ArcAvatarColorsReserved: () => ut,
          ArcAvatarOverflow: () => ho,
          ArcAvatarOverflowSizes: () => xt,
          ArcAvatarPile: () => Et,
          ArcAvatarPileSizes: () => ft,
          ArcAvatarSizes: () => vt,
          ArcAvatarText: () => _t,
          ArcAvatarTextGapSizes: () => mt,
          ArcAvatarTextOverflows: () => gt,
          ArcAvatarTextSizes: () => bt,
          ArcBadge: () => Ao,
          ArcBadgeContrasts: () => yo,
          ArcBadgeCount: () => _o,
          ArcBadgeCountShapes: () => So,
          ArcBadgeCountSizes: () => ko,
          ArcBadgeCountVariants: () => Co,
          ArcBadgeLayouts: () => $o,
          ArcBadgeSizes: () => xo,
          ArcBadgeVariants: () => wo,
          ArcButton: () => kr,
          ...
          ArcButtonShapes: () => Yt,
          ArcButtonSizes: () => Xt,
          ArcButtonVariants: () => Wt,
          ArcCheckbox: () => Pe,
          ArcCheckboxBar: () => Uo,
          ArcCheckboxBarLayouts: () => Ho,
          ArcCheckboxBarOption: () => Vo,
          ArcCheckboxBarSizes: () => No,
          ArcCheckboxLayouts: () => Lo,
          ArcCheckboxSizes: () => Oo,
          ArcCheckboxVariants: () => Mo,
          ArcIcon: () => j,
          ArcIconText: () => Ur,
          ArcIconTextVariants: () => bo,
          ArcInputAction: () => Fo,
          ArcLabel: () => $r,
          ArcLabelContent: () => yr,
          ArcLabelLayouts: () => Eo,
          ...
          ArcLinkVariants: () => Zo,
          ArcPopover: () => Ca,
          ArcPopoverAnchors: () => xe,
          ArcPopoverBoundaries: () => $e,
          ArcPopoverButton: () => Qr,
          ArcPopoverDefaults: () => Q,
          ArcPopoverModes: () => fe,
          ArcPopoverVariants: () => Aa,
          ArcPopoverVariantsWithOutline: () => It,
          ArcRadio: () => Re,
          ArcRadioBar: () => ri,
          ArcRadioBarLayouts: () => Ko,
          ArcRadioBarOption: () => Qo,
          ArcRadioBarSizes: () => Jo,
          ArcRadioLayouts: () => qo,
          ArcRadioSizes: () => Wo,
          ArcSwitch: () => oi,
          ArcSwitchLabelPositions: () => _r,
          ArcSwitchSizes: () => ai,
          ArcSwitchStates: () => O,
          ArcSystemAlignments: () => Ia,
          ArcSystemColors: () => la,
          ArcSystemLayouts: () => or,
          ArcSystemLineHeights: () => Pa,
          ArcSystemPopoverModes: () => sa,
          ArcSystemShapes: () => ca,
          ArcSystemSizes: () => G,
          ArcSystemVariants: () => Y,
          ArcTextAlignments: () => hi,
          ArcTextBodyElements: () => Oe,
          ArcTextBodySizes: () => di,
          ArcTextBodyVariants: () => pi,
          ArcTextElements: () => Me,
          ArcTextHeadingElements: () => Le,
          ArcTextHeadingSizes: () => ci,
          ArcTextHeadingVariants: () => li,
          ArcTextInput: () => Ui,
          ArcTextInputLayouts: () => Bi,
          ArcTextInputSizes: () => Hi,
          ArcTextInputTypes: () => Vi,
          ArcTextInputVariants: () => Ni,
          ArcTextKinds: () => ii,
          ArcTextLineHeights: () => ui,
          ArcTextSubheadingSizes: () => si,
          ArcTextTitleSizes: () => ni,
          ArcToast: () => Ne,
          ArcToastPlacements: () => Ki,
          ArcToastPopoverModes: () => Gi,
          ArcToastProgressBarVariants: () => Ji,
          ArcToastSeverities: () => Xi,
          ArcToastSizes: () => qi,
          ArcToastVariants: () => Wi,
          LogoArticulate: () => se,
          LogoProductAI: () => le,
          LogoProductPeek: () => de,
          LogoProductReach: () => pe,
          LogoProductReview: () => he,
          LogoProductRise: () => ue,
          LogoProductStoryline: () => ve,
          adoptStyles: () => _,
          assignRef: () => We,
          clamp: () => Oa,
          css: () => h,
          didElementRectChange: () => Ma,
          extractTextFromReactNode: () => Hr,
          getPopoverId: () => Se,
          isDifferent: () => vr,
          isSame: () => Xr,
          joinArray: () => rn,
          ...
          mapDeprecated: () => qe,
          pickFromList: () => y,
          updatePopoverPosition: () => za,
        }));
      const ca = ['circle', 'square', 'narrow'],
        Y = [
          'inherit',
          'common',
          'disabled',
        ...
        or = ['hug', 'fill', 'icon', 'gutter', 'inline'],
        sa = ['', 'auto', 'manual'],
        Ia = [
          'inherit',
          'start',
        ...
        Pa = ['inherit', 'tight', 'standard', 'loose'],
        G = ['inherit', 'xxl', 'xl', 'lg', 'md', 'sm', 'xs', 'xxs'],
        la = [
          'blue',
          'orange',
          'mint',
        ...
        da = ['inherit', 'xl', 'lg', 'md', 'sm', 'xs'],
        Ra = ['inherit', 'lg', 'md', 'sm'],
        Ze = ['inherit', 'md', 'sm'],
        La = ['inherit', 'wrap', 'truncate'],
        Ye = ['gutter', 'inline'],
        Xe = ['hug', 'fill'],
        qe = (a, r) => r[a] || a,
        y = (a, r) => a.filter((e) => r.includes(e)),
        We = (a, r) => {
          a && (typeof a == 'function' ? a(r) : (a.current = r));
        },
        Oa = (a, r = 0, e = 100) => Math.min(Math.max(a, r), e),
        vr = (a, r) => a !== r,
        Xr = (a, r) => a === r,
        Ma = ({ a, b: r }) =>
          vr(a?.top, r?.top) ||
       ...
       */ const qr = globalThis,
        pa =
          qr.ShadowRoot &&
          (qr.ShadyCSS === void 0 || qr.ShadyCSS.nativeShadow) &&
      ...
      const Ge = (a) => new Ha(typeof a == 'string' ? a : a + '', void 0, ha),
        h = (a, ...r) => {
          const e =
            a.length === 1
              ? a[0]
          ...
          return new Ha(e, a, ha);
        },
        Ke = (a, r) => {
          if (pa)
            a.adoptedStyleSheets = r.map((e) =>
       ...
       */ const {
        ...
        Wr = globalThis,
        Va = Wr.trustedTypes,
        ot = Va ? Va.emptyScript : '',
        it = Wr.reactiveElementPolyfillSupport,
        Pr = (a, r) => a,
        ua = {
          toAttribute(a, r) {
            switch (r) {
      ...
      ((Symbol.metadata ??= Symbol('metadata')),
        (Wr.litPropertyMetadata ??= new WeakMap()));
      class wr extends HTMLElement {
        ...
        static createProperty(r, e = Fa) {
          if (
            (e.state && (e.attribute = !1),
            this._$Ei(),
            this.prototype.hasOwnProperty(r) &&
              ((e = Object.create(e)).wrapped = !0),
            this.elementProperties.set(r, e),
            !e.noAccessor)
          ) {
            const o = Symbol(),
              n = this.getPropertyDescriptor(r, o, e);
            n !== void 0 && Qe(this.prototype, r, n);
          }
        }
        static getPropertyDescriptor(r, e, o) {
          const { get: n, set: c } = rt(this.prototype, r) ?? {
            get() {
              return this[e];
            },
            set(s) {
          ...
          return {
            ...
            set(s) {
              const m = n?.call(this);
              (c?.call(this, s), this.requestUpdate(r, m, o));
            },
            configurable: !0,
            enumerable: !0,
          };
        ...
        static getPropertyOptions(r) {
          return this.elementProperties.get(r) ?? Fa;
        }
        static _$Ei() {
        ...
        static finalize() {
          ...
          if (r !== null) {
            ...
            if (e !== void 0)
              for (const [o, n] of e) this.elementProperties.set(o, n);
          }
          this._$Eh = new Map();
        ...
        static finalizeStyles(r) {
          ...
          if (Array.isArray(r)) {
            ...
            for (const n of o) e.unshift(Na(n));
          } else r !== void 0 && e.push(Na(r));
          return e;
        }
        static _$Eu(r, e) {
          const o = e.attribute;
        ...
        _$Ev() {
          ((this._$ES = new Promise((r) => (this.enableUpdating = r))),
            ...
            this._$E_(),
            this.requestUpdate(),
            this.constructor.l?.forEach((r) => r(this)));
        }
        addController(r) {
          ((this._$EO ??= new Set()).add(r),
        ...
        createRenderRoot() {
          ...
          return (Ke(r, this.constructor.elementStyles), r);
        }
        connectedCallback() {
          ((this.renderRoot ??= this.createRenderRoot()),
            this.enableUpdating(!0),
            this._$EO?.forEach((r) => r.hostConnected?.()));
        }
        enableUpdating(r) {}
        ...
        _$ET(r, e) {
          const o = this.constructor.elementProperties.get(r),
            n = this.constructor._$Eu(r, o);
          if (n !== void 0 && o.reflect === !0) {
            const c = (
              o.converter?.toAttribute !== void 0 ? o.converter : ua
            ).toAttribute(e, o.type);
            ((this._$Em = r),
              c == null ? this.removeAttribute(n) : this.setAttribute(n, c),
              (this._$Em = null));
          }
        }
        _$AK(r, e) {
          ...
          if (n !== void 0 && this._$Em !== n) {
            const c = o.getPropertyOptions(n),
              s =
            ...
            ((this._$Em = n),
              (this[n] =
                s.fromAttribute(e, c.type) ?? this._$Ej?.get(n) ?? null),
              (this._$Em = null));
          }
        }
        requestUpdate(r, e, o) {
        ...
        C(r, e, { useDefault: o, reflect: n, wrapped: c }, s) {
          (o &&
            !(this._$Ej ??= new Map()).has(r) &&
            (this._$Ej.set(r, s ?? e ?? this[r]), c !== !0 || s !== void 0)) ||
            (this._$AL.has(r) ||
              (this.hasUpdated || o || (e = void 0), this._$AL.set(r, e)),
            n === !0 && this._$Em !== r && (this._$Eq ??= new Set()).add(r));
        }
        async _$EP() {
        ...
        performUpdate() {
          ...
          const e = this._$AL;
          try {
            ((r = this.shouldUpdate(e)),
              r
                ? (this.willUpdate(e),
                  this._$EO?.forEach((o) => o.hostUpdate?.()),
                  this.update(e))
                : this._$EM());
          } catch (o) {
            throw ((r = !1), this._$EM(), o);
          }
          r && this._$AE(e);
        }
        willUpdate(r) {}
      ...
      ((wr.elementStyles = []),
        (wr.shadowRootOptions = { mode: 'open' }),
        (wr[Pr('elementProperties')] = new Map()),
        (wr[Pr('finalized')] = new Map()),
        it?.({ ReactiveElement: wr }),
       ...
       */ const va = globalThis,
        Gr = va.trustedTypes,
        Da = Gr
          ? Gr.createPolicy('lit-html', { createHTML: (a) => a })
          : void 0,
        ma = '$lit$',
        ir = `lit$${Math.random().toFixed(9).slice(2)}$`,
        ga = '?' + ir,
        nt = `<${ga}>`,
        mr = document,
        Rr = () => mr.createComment(''),
        ...
        ba = Array.isArray,
        Za = (a) => ba(a) || typeof a?.[Symbol.iterator] == 'function',
        fa = `[ 	
\f\r]`,
        Or = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
        Ya = /-->/g,
        Xa = />/g,
        gr = RegExp(
          `>|${fa}(?:([^\\s"'>=/]+)(${fa}*=${fa}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,
        ...
        cn = xa(2),
        sn = xa(3),
        Ar = Symbol.for('lit-noChange'),
        L = Symbol.for('lit-nothing'),
        Ka = new WeakMap(),
        br = mr.createTreeWalker(mr, 129);
      function Ja(a, r) {
        if (!ba(a) || !a.hasOwnProperty('raw'))
          throw Error('invalid template strings array');
        return Da !== void 0 ? Da.createHTML(r) : r;
      }
      const Qa = (a, r) => {
        const e = a.length - 1,
          o = [];
        ...
        for (let m = 0; m < e; m++) {
          ...
          for (
            ;
            f < l.length && ((s.lastIndex = f), (g = s.exec(l)), g !== null);
              ...
              s === Or
                ...
                : s === gr
                  ? g[0] === '>'
                    ...
                    : g[1] === void 0
                      ? (v = -2)
                      : ((v = s.lastIndex - g[2].length),
                        (p = g[1]),
                        (s = g[3] === void 0 ? gr : g[3] === '"' ? Wa : qa))
                  : s === Wa || s === qa
                    ? (s = gr)
                    : s === Ya || s === Xa
                      ? (s = Or)
                      : ((s = gr), (n = void 0)));
          const x = s === gr && a[m + 1].startsWith('/>') ? ' ' : '';
          c +=
            s === Or
              ? l + nt
              : v >= 0
                ? (o.push(p), l.slice(0, v) + ma + l.slice(v) + ir + x)
                : l + ir + (v === -2 ? m : x);
        }
        return [
          Ja(
      ...
      class Mr {
        constructor({ strings: r, _$litType$: e }, o) {
          ...
          const m = r.length - 1,
            ...
            [p, g] = Qa(r, e);
          if (
            ((this.el = Mr.createElement(p, o)),
            (br.currentNode = this.el.content),
            e === 2 || e === 3)
          ) {
            const v = this.el.content.firstChild;
            v.replaceWith(...v.childNodes);
          }
          for (; (n = br.nextNode()) !== null && l.length < m; ) {
            if (n.nodeType === 1) {
              if (n.hasAttributes())
                for (const v of n.getAttributeNames())
                  if (v.endsWith(ma)) {
                    const f = g[s++],
                      x = n.getAttribute(v).split(ir),
                      z = /([.?@])?(.*)/.exec(f);
                    (l.push({
                      type: 1,
                      index: c,
                    ...
                    v.startsWith(ir) &&
                      (l.push({ type: 6, index: c }), n.removeAttribute(v));
              if (Ga.test(n.tagName)) {
                const v = n.textContent.split(ir),
                  f = v.length - 1;
                if (f > 0) {
                  n.textContent = Gr ? Gr.emptyScript : '';
                  for (let x = 0; x < f; x++)
                    (n.append(v[x], Rr()),
                      br.nextNode(),
                      l.push({ type: 2, index: ++c }));
                  n.append(v[f], Rr());
                }
              }
            } else if (n.nodeType === 8)
              if (n.data === ga) l.push({ type: 2, index: c });
              else {
                let v = -1;
                for (; (v = n.data.indexOf(ir, v + 1)) !== -1; )
                  (l.push({ type: 7, index: c }), (v += ir.length - 1));
              }
            c++;
          }
        }
        static createElement(r, e) {
          const o = mr.createElement('template');
          return ((o.innerHTML = r), o);
        }
      }
      function fr(a, r, e = a, o) {
        if (r === Ar) return r;
        let n = o !== void 0 ? e._$Co?.[o] : e._$Cl;
        const c = Lr(r) ? void 0 : r._$litDirective$;
        return (
          n?.constructor !== c &&
            (n?._$AO?.(!1),
            c === void 0 ? (n = void 0) : ((n = new c(a)), n._$AT(a, e, o)),
            o !== void 0 ? ((e._$Co ??= [])[o] = n) : (e._$Cl = n)),
          n !== void 0 && (r = fr(a, n._$AS(a, r.values), n, o)),
          r
        );
      }
      class re {
        ...
        u(r) {
          const {
            ...
            n = (r?.creationScope ?? mr).importNode(e, !0);
          br.currentNode = n;
          let c = br.nextNode(),
            s = 0,
            m = 0,
          ...
          for (; l !== void 0; ) {
            if (s === l.index) {
              let p;
              (l.type === 2
                ? (p = new zr(c, c.nextSibling, this, r))
                : l.type === 1
                  ? (p = new l.ctor(c, l.name, l.strings, this, r))
                  : l.type === 6 && (p = new oe(c, this, r)),
                this._$AV.push(p),
                (l = o[++m]));
            }
            s !== l?.index && ((c = br.nextNode()), s++);
          }
          return ((br.currentNode = mr), n);
        }
        p(r) {
          let e = 0;
          for (const o of this._$AV)
            (o !== void 0 &&
              (o.strings !== void 0
                ? (o._$AI(r, o, e), (e += o.strings.length - 2))
                : o._$AI(r[e])),
              e++);
        }
      }
      class zr {
        ...
        get parentNode() {
          ...
          const e = this._$AM;
          return (e !== void 0 && r?.nodeType === 11 && (r = e.parentNode), r);
        }
        get startNode() {
          return this._$AA;
        }
        ...
        _(r) {
          (this._$AH !== L && Lr(this._$AH)
            ? (this._$AA.nextSibling.data = r)
            : this.T(mr.createTextNode(r)),
            (this._$AH = r));
        }
        $(r) {
          const { values: e, _$litType$: o } = r,
            n =
              typeof o == 'number'
                ? this._$AC(r)
                : (o.el === void 0 &&
                    (o.el = Mr.createElement(Ja(o.h, o.h[0]), this.options)),
                  o);
          if (this._$AH?._$AD === n) this._$AH.p(e);
          else {
            const c = new re(n, this),
              s = c.u(this.options);
            (c.p(e), this.T(s), (this._$AH = c));
          }
        }
        _$AC(r) {
          let e = Ka.get(r.strings);
          return (e === void 0 && Ka.set(r.strings, (e = new Mr(r))), e);
        }
        k(r) {
          ...
          for (const c of r)
            (n === e.length
              ? e.push(
                  (o = new zr(this.O(Rr()), this.O(Rr()), this, this.options))
                )
              : (o = e[n]),
              o._$AI(c),
              n++);
          n < e.length &&
            (this._$AR(o && o._$AB.nextSibling, n), (e.length = n));
        }
        _$AR(r = this._$AA.nextSibling, e) {
          for (this._$AP?.(!1, !0, e); r && r !== this._$AB; ) {
      ...
      class Br {
        ...
        _$AI(r, e = this, o, n) {
          ...
          if (c === void 0)
            ((r = fr(this, r, e, 0)),
              (s = !Lr(r) || (r !== this._$AH && r !== Ar)),
              s && (this._$AH = r));
          else {
            const m = r;
            let l, p;
            for (r = c[0], l = 0; l < c.length - 1; l++)
              ((p = fr(this, m[o + l], e, l)),
                p === Ar && (p = this._$AH[l]),
                (s ||= !Lr(p) || p !== this._$AH[l]),
                p === L ? (r = L) : r !== L && (r += (p ?? '') + c[l + 1]),
                (this._$AH[l] = p));
          }
          s && !n && this.j(r);
        }
      ...
      class ae extends Br {
        ...
        j(r) {
          this.element[this.name] = r === L ? void 0 : r;
        }
      }
      class ee extends Br {
        constructor() {
        ...
        j(r) {
          this.element.toggleAttribute(this.name, !!r && r !== L);
        }
      }
      class te extends Br {
        constructor(r, e, o, n, c) {
          (super(r, e, o, n, c), (this.type = 5));
        }
        _$AI(r, e = this) {
          if ((r = fr(this, r, e, 0) ?? L) === Ar) return;
          const o = this._$AH,
            n =
              (r === L && o !== L) ||
              r.capture !== o.capture ||
        ...
        handleEvent(r) {
          typeof this._$AH == 'function'
            ? this._$AH.call(this.options?.host ?? this.element, r)
      ...
      const ln = {
        ...
        ct = va.litHtmlPolyfillSupport;
      (ct?.(Mr, zr), (va.litHtmlVersions ??= []).push('3.3.0'));
      const st = (a, r, e) => {
        const o = e?.renderBefore ?? r;
        let n = o._$litPart$;
        if (n === void 0) {
          const c = e?.renderBefore ?? null;
          o._$litPart$ = n = new zr(
            r.insertBefore(Rr(), c),
            c,
            void 0,
            e ?? {}
      ...
      class Kr extends wr {
        ...
        update(r) {
          ...
          (this.hasUpdated ||
            ...
            super.update(r),
            (this._$Do = st(e, this.renderRoot, this.renderOptions)));
        }
        connectedCallback() {
      ...
      ((Kr._$litElement$ = !0),
        (Kr.finalized = !0),
        $a.litElementHydrateSupport?.({ LitElement: Kr }));
      const lt = $a.litElementPolyfillSupport;
      lt?.({ LitElement: Kr });
      const dn = {
        _$AK: (a, r, e) => {
          a._$AK(r, e);
      ...
      ($a.litElementVersions ??= []).push('4.2.0');
      const ie = {};
      function _(a, r) {
        if (typeof document < 'u' && r?.styleSheet) {
          ...
          ((ie[a] = r.styleSheet),
            (document.adoptedStyleSheets = [
              ...document.adoptedStyleSheets.filter((o) => o !== e),
              r.styleSheet,
            ]));
        }
      }
      const b = h`arc•avatar`,
        I = h`arc•modifier`,
        B = h`${b}•computed`,
        ar = h`${b}•mask`,
        dt = (a) => a?.trim().charAt(0) ?? void 0,
        pt = (a, r) => {
          let e = 0;
          const o = Math.min(a.length, 50);
          for (let n = 0; n < o; n += 1) e = (e + a.charCodeAt(n)) % (r ?? 33);
          return e;
        },
        ht = (a, r, e) =>
          r?.length
        ...
        ut = y(la, ['neutral', 'white', 'black']),
        Jr = y(G, ['lg', 'md', 'sm', 'xs']),
        vt = [...Jr, 'profile-sm', 'profile-md', 'profile-lg'],
        mt = Ra,
        gt = La,
        bt = Jr,
        ft = Jr,
...
`,
        yt = ({ children: a, initial: r, color: e, ...o }) =>
          (0, i.jsx)('span', {
            ...o,
            'data-element': 'initial',
            'data-color': e,
        ...
        wt = ({ isLoaded: a, hasError: r, onLoad: e, onError: o, ...n }) => {
          const c = (!a && '') || void 0,
            s = (r && '') || void 0,
            m = !a || r || void 0;
          return (0, i.jsx)('img', {
            ...
            children: [
              (0, i.jsx)('defs', {
                children: (0, i.jsxs)('linearGradient', {
                  ...
                  children: [
                    (0, i.jsx)('stop', {
                      stopColor: 'var(--arc-color-logo-ai-purple, #9c15ff)',
                    }),
                    (0, i.jsx)('stop', {
                      offset: '1',
...
`,
        zt = (a) =>
          typeof a == 'number'
            ? `calc(${a / 10}rem * var(--arc-internal-font-size))`
            : a,
        j = ({
          children: a,
          ...
          const s = { ...n, '--arc-icon-size': zt(o), '--arc-icon-color': e },
            m = !!(c['aria-label'] || c['aria-labelledby']),
            l =
              typeof r == 'string' && r.length > 0
                ? (0, i.jsx)('span', { className: r })
                : r;
          return (0, i.jsx)('span', {
      ...
      ((j.Articulate = (a) =>
        (0, i.jsx)(j, { ...a, icon: (0, i.jsx)(se, {}) })),
        (j.AI = (a) => (0, i.jsx)(j, { ...a, icon: (0, i.jsx)(le, {}) })),
        (j.Peek = (a) => (0, i.jsx)(j, { ...a, icon: (0, i.jsx)(de, {}) })),
        (j.Reach = (a) => (0, i.jsx)(j, { ...a, icon: (0, i.jsx)(pe, {}) })),
        (j.Review = (a) => (0, i.jsx)(j, { ...a, icon: (0, i.jsx)(he, {}) })),
        (j.Rise = (a) => (0, i.jsx)(j, { ...a, icon: (0, i.jsx)(ue, {}) })),
        (j.Storyline = (a) =>
          (0, i.jsx)(j, { ...a, icon: (0, i.jsx)(ve, {}) })),
        _('ArcIcon', At));
      const kt = ({ children: a, icon: r, color: e, ...o }) =>
          (0, i.jsx)('span', {
            ...o,
            'data-element': 'anonymous',
            'data-color': 'neutral',
            children: a || (0, i.jsx)(j, { icon: r }),
          }),
        me = 'blue',
        ge = 'neutral',
        Ct = 'fa-solid fa-user',
          ...
          (
            ...
            return (
              ...
              (0, i.jsx)('span', {
                ...
                ref: g,
                'arc-avatar': '',
                'data-is-inactive': !o || void 0,
                'data-size': r,
                'aria-label': (p.title ?? m ?? l) || void 0,
                children:
                  a ||
                  (C
                    ? (0, i.jsx)(kt, { icon: Ct, color: ge })
                    : (0, i.jsxs)(i.Fragment, {
                        children: [
                          D && (0, i.jsx)(wt, { ...dr }),
                          A && (0, i.jsx)(yt, { initial: V, color: rr }),
                        ],
                      })),
              })
            );
...
`,
        ...
        _t = ({
          ...
          const m = r.name || r.email || r.src,
            l = r.name || r.email || be,
            p = r.isAnonymous || !m,
            g = a || p ? be : l,
            v = n !== 'inherit' ? n : void 0,
            f = c !== 'inherit' ? c : void 0;
          return (0, i.jsxs)('span', {
            ...
            'data-overflow': f,
            children: [
              (0, i.jsx)(wa, { ...r, isAnonymous: p, size: o }),
              (0, i.jsxs)('span', {
                'data-element': 'text',
                children: [
                  g,
...
`,
        Et = ({ size: a = 'md', ...r }) =>
          (0, i.jsx)('div', { ...r, 'arc-avatar-pile': '', 'data-size': a });
      _('ArcAvatarPile', jt);
      const Hr = (a) =>
          typeof a == 'string'
            ? a
            : typeof a == 'number'
              ...
              : Array.isArray(a)
                ...
                : (0, $.isValidElement)(a)
                  ? Hr(a.props.children)
                  : '',
        Tt = () => Math.random().toString(16).slice(-6),
        nr = (a) => `${a || 'id'}-${Tt()}`,
        fe = [...sa],
        Aa = y(Y, ['common']),
        It = y(Y, ['ai', 'brand']),
        ...
        ye = (a, r) =>
          a.a.top + a.p.height + r.y <= a.v.height - a.v.threshold &&
          a.a.top >= a.v.threshold,
        we = (a, r) =>
          a.a.left + a.p.width + r.x <= a.v.width - a.v.threshold &&
          a.a.left >= a.v.threshold,
        Ae = (a, r) =>
        ...
        Ce = (a, r) =>
          a.a.right <= a.v.width - a.v.threshold &&
          a.a.right - a.p.width + r.x >= a.v.threshold,
        Nr = {
          'top-start': {
            ...w.Top,
            ...w.StartY,
            fitCheck: (a, r) => K(a, r, w.Top.edge) && we(a, r),
            flip: 'bottom-start',
          },
          'top-center': {
            ...w.Top,
            ...w.CenterY,
            fitCheck: (a, r) => K(a, r, w.Top.edge) && ze(a, r),
            flip: 'bottom-center',
          },
          'top-end': {
            ...w.Top,
            ...w.EndY,
            fitCheck: (a, r) => K(a, r, w.Top.edge) && Ce(a, r),
            flip: 'bottom-end',
          },
          'right-start': {
            ...w.Right,
            ...w.StartX,
            fitCheck: (a, r) => K(a, r, w.Right.edge) && ye(a, r),
            flip: 'left-start',
          },
          'right-center': {
            ...w.Right,
            ...w.CenterX,
            fitCheck: (a, r) => K(a, r, w.Right.edge) && Ae(a, r),
            flip: 'left-center',
          },
          'right-end': {
            ...w.Right,
            ...w.EndX,
            fitCheck: (a, r) => K(a, r, w.Right.edge) && ke(a, r),
            flip: 'left-end',
          },
          center: {
            ...w.Center,
          ...
          'bottom-start': {
            ...w.Bottom,
            ...w.StartY,
            fitCheck: (a, r) => K(a, r, w.Bottom.edge) && we(a, r),
            flip: 'top-start',
          },
          'bottom-center': {
            ...w.Bottom,
            ...w.CenterY,
            fitCheck: (a, r) => K(a, r, w.Bottom.edge) && ze(a, r),
            flip: 'top-center',
          },
          'bottom-end': {
            ...w.Bottom,
            ...w.EndY,
            fitCheck: (a, r) => K(a, r, w.Bottom.edge) && Ce(a, r),
            flip: 'top-end',
          },
          'left-start': {
            ...w.Left,
            ...w.StartX,
            fitCheck: (a, r) => K(a, r, w.Left.edge) && ye(a, r),
            flip: 'right-start',
          },
          'left-center': {
            ...w.Left,
            ...w.CenterX,
            fitCheck: (a, r) => K(a, r, w.Left.edge) && Ae(a, r),
            flip: 'right-center',
          },
          'left-end': {
            ...w.Left,
            ...w.EndX,
            fitCheck: (a, r) => K(a, r, w.Left.edge) && ke(a, r),
            flip: 'right-end',
          },
        },
        Q = {
        ...
        Rt = (a, r, e = Q.offset, o = Q.tailSize, n = Q.threshold) => ({
          a: _e(a?.getBoundingClientRect() ?? new DOMRect()),
          p: _e(r?.getBoundingClientRect() ?? new DOMRect()),
          o: e,
          v: Pt(n),
          t: o,
        }),
        ...
        Lt = (a, r) =>
          [...Object.keys(Nr)]
            .filter((e) =>
              vr(e, a) && vr(r.align, 'center') ? !e.includes('center') : e
            )
            .sort((e, o) => {
              const n = Xr(Nr[e].edge, r.edge),
                c = Xr(Nr[o].edge, r.edge),
                s = n ? -1 : 1;
              return Xr(n, c) ? 0 : s;
            }),
        Ee = ({ anchorAt: a, measurements: r }) => {
          const e = Nr[a],
            o = je(e.edge, r.o, e.pMod);
          return { cx: r.a.cx, cy: r.a.cy, offsets: o, config: e };
        },
        Ot = ({ anchorAt: a, measurements: r }) => {
          const { offsets: e, config: o } = Ee({
            anchorAt: a,
            measurements: r,
          });
          return o.fitCheck(r, e)
            ? a
            : ([o.flip, ...Lt(a, o)].find((n) => {
                const c = Nr[n],
                  s = je(c.edge, r.o, c.pMod);
                return c.fitCheck(r, s);
              }) ?? a);
        },
        cr = (a, r = 'px') => `${a}${r}`,
        za = ({
          ...
          const m = e,
            l = Rt(a, r, n, c, s),
            p = o === 'flip' ? Ot({ anchorAt: m, measurements: l }) : m,
            { cx: g, cy: v } = Ee({ anchorAt: p, measurements: l }),
            f = { cx: g, cy: v },
            x =
              a?.dataset?.layout === 'icon' ||
              l.t > 0 ||
              (!e?.includes('-center') &&
          ...
          return {
            anchorAt: p,
            vars: {
              '--js-cx': cr((f.cx + window.scrollX).toFixed(2)),
              '--js-cy': cr((f.cy + window.scrollY).toFixed(2)),
              '--js-w': cr(l.a.width.toFixed(2)),
              '--js-h': cr(l.a.height.toFixed(2)),
              '--js-cw': cr(l.a.cw.toFixed(2)),
              '--js-ch': cr(l.a.ch.toFixed(2)),
              '--js-o': cr(l.o.toFixed(2)),
              '--js-t': cr(l.t, ''),
              '--js-i': x ? '1' : '0',
              '--js-m': cr(Oa(l.t, l.a.height, l.a.cw).toFixed(2)),
            },
          };
        },
        t = h`arc•button`,
...
`,
        Yt = y(ca, ['circle', 'square', 'narrow']),
        Xt = y(G, ['xxl', 'xl', 'lg', 'md', 'sm']),
        qt = y(or, ['hug', 'fill', 'icon']),
        Wt = y(Y, [
          'primary',
          'secondary',
          'tertiary',
        ...
        kr = (0, $.forwardRef)(({ children: a, ...r }, e) => {
          const {
              iconEnd: o,
              iconStart: n,
              icon: c,
          ...
          return (0, i.jsxs)(rr, {
            ...
            type: dr,
            'data-layout': z,
            'data-shape': A ? void 0 : T,
            'data-size': A ? void 0 : M,
            'data-variant': A ? void 0 : V,
            'is-active': m ? '' : void 0,
            'is-processing': p ? '' : void 0,
            'is-disabled': Z ? '' : void 0,
            'aria-disabled': Z || void 0,
            children: [
              (0, i.jsxs)('span', {
                'arc-button-content': '',
                children: [
                  !!tr && (0, i.jsx)(j, { 'arc-button-icon': '', icon: tr }),
                  !!Er &&
                    (0, i.jsx)('span', {
                      'arc-button-label': '',
                      children: Er,
                    }),
                  !!_a && (0, i.jsx)(j, { 'arc-button-icon': '', icon: o }),
                ],
              }),
              p && Gt,
            ],
      ...
      ((kr.displayName = 'ArcButton'), _('ArcButton', Zt));
      const Qr = (0, $.forwardRef)((a, r) =>
          (0, i.jsx)(kr, { ...a, ref: r, 'arc-popover-button': '' })
        ),
        Te = ({ isInverse: a, isOpen: r, ...e }) =>
          (0, i.jsx)(kr, {
            ...
            shape: 'square',
            size: 'sm',
            variant: a ? 'tertiary-inverse' : 'tertiary',
            ...e,
            'arc-popover-dismiss': '',
          }),
        Kt = ({
          ...
          (0, i.jsxs)(o, {
            ...n,
            'arc-popover-header': '',
            children: [a, r && (0, i.jsx)(Te, { ...e })],
          }),
        Jt = ({ tag: a = 'article', ...r }) =>
          (0, i.jsx)(a, { ...r, 'arc-popover-body': '' }),
        Qt = ({ showDivider: a, tag: r = 'footer', ...e }) =>
          (0, i.jsx)(r, {
            ...e,
            'arc-popover-footer': '',
            'has-divider': a ? '' : void 0,
          }),
        ro = (a) => (0, i.jsx)('span', { ...a, 'arc-popover-tail': '' });
      Qr.displayName = 'ArcPopoverButton';
      const xr = h`arc•modifier`,
        u = h`arc•popover`,
        hr = h`${u}•computed`,
        S = h`${u}•space`,
        X = h`${u}•shift`,
...
`,
        aa = { SETUP: ao, POSITION: eo, VARIANTS: to, ELEMENTS: oo },
        io = h`
@layer arc-components {
  [arc-popover] {
    ${aa.SETUP}
...
`,
        ...
        ka = (0, $.forwardRef)(
          (
            ...
            const dr = (0, $.useRef)(null),
              Z = (0, $.useRef)(null);
            (0, $.useImperativeHandle)(rr, () => Z.current);
            const [tr, Er] = (0, $.useState)(!1),
              [_a, Ve] = (0, $.useState)(n || Q.anchorAt),
              [an, Ue] = (0, $.useState)({}),
              [ta, en] = (0, $.useState)(0),
              [oa, tn] = (0, $.useState)(l ? (g ?? 0) : 0),
              ja = (0, $.useMemo)(() => m && [...Aa].includes(s), [s, m]),
              ia = (0, $.useMemo)(
                () => ({
                  popovertarget: D.id,
                  'aria-haspopup': !0,
            ...
            return (
              ...
              (0, $.useEffect)(() => {
                ...
                return (
                  J.addEventListener('toggle', ur),
                  () => {
                    J.removeEventListener('toggle', ur);
                  }
                );
              }, [Z, C, Tr, n, c, oa, ta, na]),
              (0, i.jsxs)(i.Fragment, {
                    ...
                    children: [
                      ...
                      (0, i.jsxs)(A, {
                        ...
                        children: [
                          ...
                          f || T ? (0, i.jsx)(Jt, { children: a }) : a,
                          !!T &&
                            (0, i.jsx)(Qt, { showDivider: M, children: T }),
                        ],
                      }),
                      x && !f && (0, i.jsx)(Te, { ...Fe }),
                    ],
      ...
      ((ka.handlePopover = no), (ka.Button = Qr));
      const Ca = ka;
      _('ArcPopover', io);
      const co = h`
@layer arc-components {
...
`,
        so = (a) => (0, i.jsx)('ul', { ...a, 'data-element': 'list' }),
        lo = (a) => (0, i.jsx)('li', { ...a, 'data-element': 'list-item' }),
        po = ({
          count: a,
          anchorId: r,
          overflowId: e,
          shouldShowOverflow: o,
          ...n
        }) =>
          (0, i.jsx)(wa, {
            title: `+${a}`,
            children: (0, i.jsx)(Ca.Button, {
              ...n,
              id: r,
              popovertarget: e,
              text: `+${a}`,
        ...
        ho = ({
          ...
          size: e = 'sm',
          overflowCount: o = 0,
          shouldShowOverflow: n = !1,
          anchorAt: c = 'bottom-end',
          boundary: s = 'flip',
          ...m
        }) => {
          const l = Math.min(o, 999),
            p = (0, $.useMemo)(() => Se(r, 'arc-avatar-overflow'), [r]),
            g = (0, $.useMemo)(() => `${p}-anchor`, [p]),
            v = (0, $.useMemo)(() => $.Children.toArray(a), [a]);
      ...
      _('ArcAvatarOverflow', co);
      const sr = h`arc•icon•text`,
        R = h`${sr}•icon`,
        E = h`${sr}•text`,
        Sr = h`${sr}•subtext`,
        lr = h`${sr}•gap`,
...
`,
        ...
        Ur = ({
          ...
          const z = a || s,
            ...
            D = T && M && v && A,
            rr = !!p && p !== 'inherit',
            dr = rr && da.includes(p) ? p : void 0,
            Z = rr && !da.includes(p) ? p : void 0,
            tr = g !== 'inherit' ? g : void 0,
            Er = l !== 'inherit' ? l : void 0;
          return (0, i.jsxs)(n, {
            ...x,
            'arc-icon-text': '',
            'data-variant': o,
            ...
            'is-strong': f ? '' : void 0,
            children: [
              C && (0, i.jsx)(j, { 'data-element': 'icon', icon: c, size: Z }),
              M &&
                (0, i.jsxs)('span', {
                  'data-element': 'text',
                  children: [
              ...
              D && (0, i.jsx)(j, { 'data-element': 'icon', icon: c, size: Z }),
            ],
          });
        };
      _('ArcIconText', go);
...
`,
        Eo = y(or, ['hug', 'fill']),
        $r = ({ layout: a, ...r }) =>
          (0, i.jsx)('label', { ...r, 'arc-label': '', 'data-layout': a });
      _('ArcLabel', jo);
      const To = h`
@layer arc-components {
...
`,
        yr = (a) => (0, i.jsx)('span', { ...a, 'arc-label-content': '' });
      _('LabelContent', To);
      const Io = { checkbox: 'checkbox', radio: 'radio', switch: 'radio' },
        Fr = ({ id: a, indeterminate: r, type: e, onChange: o, ...n }) => {
          const c = e === 'checkbox' && !!r,
            s = (0, $.useRef)(null),
            m = (0, $.useMemo)(() => a || nr(`arc-${e}`), [a]),
            l = (p) => (g) => {
              if (!(g?.target instanceof HTMLInputElement)) return;
              const v = {
                checked: g?.target.checked,
                indeterminate: g?.target?.indeterminate,
                name: g?.target?.name,
                value: n?.value,
              };
              p?.(v, g);
          ...
          return (
            (0, $.useEffect)(() => {
              s.current?.type === 'checkbox' && (s.current.indeterminate = !!r);
            }, [r]),
            (0, i.jsx)('input', {
              ...n,
              id: m,
              ...
              'data-is-disabled': n?.disabled || void 0,
...
`,
        ea = ({ type: a, ...r }) =>
          (0, i.jsx)('span', {
            'arc-input-mask-wrapper': '',
            children: (0, i.jsx)('span', { ...r, 'arc-input-mask': a }),
          });
      _('ArcBooleanInputMask', Po);
      const Ro = h`
@layer arc-components {
...
`,
        Lo = y(or, ['hug', 'fill']),
        Oo = y(G, ['inherit', 'md', 'sm']),
        Mo = y(Y, ['primary', 'secondary']),
        Pe = ({
          children: a,
          label: r,
          layout: e,
          ...
          const { className: m, title: l, ...p } = s,
            g = { className: m, title: l },
            v = a ?? r,
            f = (0, i.jsx)(Fr, { ...p, type: 'checkbox' }),
            x =
              c &&
              (0, i.jsxs)(ea, {
                type: 'checkbox',
            ...
            z =
              ...
              (0, i.jsxs)($r, {
                layout: e,
                children: [x || f, (0, i.jsx)(yr, { children: v })],
              });
          return (0, i.jsx)('span', {
            ...g,
            'arc-checkbox': '',
...
`,
        Ho = y(or, ['hug', 'fill']),
        No = y(G, ['lg', 'md']),
        Vo = ({ children: a, label: r, icon: e, ...o }) => {
          const n = a || (0, i.jsx)(Ur, { icon: e, text: r });
          return (0, i.jsx)('li', {
            'arc-checkbox-bar-option': '',
        ...
        Uo = ({ children: a, size: r = 'lg', layout: e = 'hug', ...o }) =>
          (0, i.jsx)('ul', {
            ...o,
            'arc-checkbox-bar': '',
            'data-size': r,
...
`,
        Zo = y(Y, ['inherit', 'primary', 'secondary', 'inverse']),
        Yo = ({
          children: a,
          layout: r = 'gutter',
          size: e = 'inherit',
...
`,
        ...
        Re = ({
          ...
          const { className: s, title: m, ...l } = c,
            p = { className: s, title: m },
            g = a ?? r,
            v = (0, i.jsx)(Fr, { ...l, type: 'radio' }),
            f =
              n &&
              (0, i.jsxs)(ea, {
                type: 'radio',
                children: [
                  v,
                  (0, i.jsx)(j, { icon: 'fa-solid fa-circle-small fa-fw' }),
                ],
              }),
            x =
              !!g &&
              (0, i.jsxs)($r, {
                layout: e,
                children: [f || v, (0, i.jsx)(yr, { children: g })],
              });
          return (0, i.jsx)('span', {
            ...p,
            'arc-radio': '',
...
`,
        Ko = y(or, ['hug', 'fill']),
        Jo = y(G, ['lg', 'md']),
        Qo = ({ children: a, label: r, icon: e, ...o }) => {
          const n = a || (0, i.jsx)(Ur, { icon: e, text: r });
          return (0, i.jsx)('li', {
            'arc-radio-bar-option': '',
            'data-is-checked': o?.checked || void 0,
        ...
        ri = ({ children: a, size: r = 'lg', layout: e = 'hug', ...o }) =>
          (0, i.jsx)('ul', {
            ...o,
            'arc-radio-bar': '',
            'data-size': r,
      ...
      _('ArcRadioBar', Go);
      const ai = y(G, ['inherit', 'md', 'sm']),
        O = { On: 'on', Off: 'off' },
        _r = { Before: 'before', After: 'after' },
        ei = ({
          disabled: a,
          id: r,
          name: e,
          ...
          const p = (0, $.useMemo)(() => e || nr('arc-switch-name'), [e]),
            g = (0, $.useMemo)(
              () => (r && `${r}-off`) || nr('arc-switch-off'),
              [r]
            ),
            v = (0, $.useMemo)(
              () => (r && `${r}-on`) || nr('arc-switch-on'),
              [r]
            ),
            f = (A) => {
              if (A.code === 'Space') {
                (A.preventDefault(), A.stopPropagation());
                const C = n === O.On ? O.Off : O.On;
                m?.({ value: C }, A);
              }
            },
            x = (A) => {
              const C = { on: Hr(s), off: Hr(c) };
              return C?.on && C?.off
                ? C[A]
                : !C?.on && C?.off
                  ? `${C?.off}: ${A}`
            ...
            z = (0, i.jsxs)(ea, {
              ...
              children: [
                ...
                (0, i.jsx)(Fr, {
                  ...
                  checked: n === O.On,
                  disabled: a,
                  'aria-label': x(O.On)?.trim(),
                  onChange: m,
                }),
                (0, i.jsx)('span', { 'data-element': 'mask' }),
              ],
            }),
            T = !s && n === O.Off ? v : g,
            M = !c && n === O.On ? g : v,
              ...
              (0, i.jsxs)(i.Fragment, {
                children: [
                  !!c &&
                    (0, i.jsx)($r, {
                      htmlFor: T,
                      'arc-switch-label': s ? O.Off : '',
                      children: (0, i.jsx)(yr, { children: c }),
                    }),
                  z,
                  !!s &&
                    (0, i.jsx)($r, {
                      htmlFor: M,
                      'arc-switch-label': c ? O.On : '',
                      children: (0, i.jsx)(yr, { children: s }),
                    }),
                ],
              });
          return (0, i.jsx)('span', {
...
`,
        oi = ({
          ...
          value: n,
          label: c,
          labelPosition: s = _r.After,
          onChange: m,
          labelOff: l,
          labelOn: p,
          ...g
        }) => {
          const v = (0, $.useMemo)(() => e || nr('arc-switch-name'), [e]),
            f = (0, $.useMemo)(() => r || nr('arc-switch'), [r]),
            x = (M, V) => {
              const A = M.checked ? O.On : O.Off;
              m?.({ ...M, value: A }, V);
            };
          !c && (p || l) && ((c = p || l), (s = p ? _r.After : _r.Before));
          const z = (0, i.jsxs)(ea, {
              type: 'checkbox',
              children: [
                (0, i.jsx)(Fr, {
      ...
      _('ArcSwitch', ti);
      const ii = ['title', 'heading', 'subheading', 'body'],
        Le = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'],
        Oe = ['code', 'div', 'li', 'p', 'pre', 'span'],
        Me = [...Le, ...Oe],
        ni = ['title-inherit', 'title-lg', 'title-md', 'title-sm'],
        ci = ['heading-inherit', 'heading-lg', 'heading-md', 'heading-sm'],
        si = [
          'subheading-inherit',
          'subheading-lg',
          'subheading-md',
        ...
        li = y(Y, ['inherit', 'primary', 'primary-inverse']),
        di = ['body-inherit', 'body-lg', 'body-md', 'body-sm', 'body-xs'],
        pi = y(Y, [
          'inherit',
          'primary',
          'secondary',
        ...
        hi = y(Ia, ['inherit', 'start', 'center', 'justify', 'end']),
        ui = y(Pa, ['inherit', 'loose', 'standard', 'tight']),
        vi = {
          h1: 'title',
          h2: 'heading',
          h3: 'heading',
        ...
        mi = (a) => {
          const {
            ...
            l = vi?.[s] ?? 'body',
            p = o?.includes('inherit') ? o?.split('-')?.[0] : o;
          return {
            ...m,
            'arc-text': p || l,
            'data-is-monospace': c ? '' : void 0,
            'data-align': r?.includes('inherit') ? void 0 : r,
            'data-variant': n?.includes('inherit') ? void 0 : n,
...
`,
        bi = (a) =>
          (0, $.forwardRef)((r, e) =>
            (0, $.createElement)(a, { ...mi({ ...r, tag: a }), ref: e })
          ),
        fi = [...Me].reduce((a, r) => ({ ...a, [r]: bi(r) }), {});
      _('Arc', gi);
      const jr = (a) =>
          (0, i.jsx)(i.Fragment, {
            children: !!a.children && (0, i.jsx)('span', { ...a }),
          }),
        xi = (a) =>
          (0, i.jsx)(i.Fragment, {
            children: !!a.children && (0, i.jsx)('span', { ...a }),
        ...
        Sa = ({ children: a, ...r }) =>
          (0, i.jsx)(i.Fragment, {
            children:
              ...
              (0, i.jsx)($r, {
                ...r,
                children: (0, i.jsx)(yr, { children: a }),
              }),
          }),
        $i = ({
          children: a,
        ...
        yi = () => (0, i.jsx)('span', { 'input-element': 'spacer' }),
        wi = (a) => (0, i.jsx)(jr, { ...a, 'input-element': 'header' }),
        Ai = (a) => (0, i.jsx)(Sa, { ...a, 'input-element': 'header-label' }),
        zi = (a) => (0, i.jsx)(jr, { ...a, 'input-element': 'header-slot' }),
        ki = (a) => (0, i.jsx)(jr, { ...a, 'input-element': 'body' }),
        Ci = (a) => (0, i.jsx)(Sa, { ...a, 'input-element': 'input-prefix' }),
        Si = (a) => (0, i.jsx)(Sa, { ...a, 'input-element': 'input-suffix' }),
        _i = (a) => (0, i.jsx)(xi, { ...a, 'input-element': 'input-action' }),
        ji = (a) => (0, i.jsx)(jr, { ...a, 'input-element': 'footer' }),
        Ei = (a) => (0, i.jsx)(jr, { ...a, 'input-element': 'footer-caption' }),
        Ti = (a) => (0, i.jsx)(jr, { ...a, 'input-element': 'footer-slot' }),
        Ii = (a) => (r) => {
...
`,
      ...
      const W = Ri,
        Li = y(or, ['fill', 'hug']),
        Oi = y(G, ['inherit', 'xl', 'lg', 'md']),
        Mi = y(Y, ['outline', 'solid']),
        Bi = Li,
        Hi = Oi,
        Ni = Mi,
        Vi = ['text', 'number', 'password', 'email', 'url'],
        Ui = (0, $.forwardRef)(
          (
            {
              layout: a = 'hug',
            ...
            return (0, i.jsxs)(W.Wrapper, {
              ...
              children: [
                D &&
                  (0, i.jsxs)(W.Header, {
                    children: [
                      (0, i.jsx)(W.HeaderLabel, { htmlFor: x, children: n }),
                      !!c && (0, i.jsx)(W.Spacer, {}),
                      (0, i.jsx)(W.HeaderSlot, { children: c }),
                    ],
                  }),
                (0, i.jsxs)(W.InputBody, {
                  children: [
                    (0, i.jsx)(W.InputPrefix, { htmlFor: x, children: s }),
                    (0, i.jsx)('input', {
                      ...T,
                      ref: f,
                      id: x,
                      'arc-input-type': M,
                      onChange: W.onChangeHandler(z),
                      'aria-disabled': V,
                      'aria-readonly': A,
                      'aria-required': C,
                    }),
                    (0, i.jsx)(W.InputSuffix, { htmlFor: x, children: l }),
                    (0, i.jsx)(W.InputAction, { children: m }),
                  ],
                }),
                rr &&
                  (0, i.jsxs)(W.Footer, {
                    children: [
                      (0, i.jsx)(W.FooterCaption, { children: p }),
                      !!g && (0, i.jsx)(W.Spacer, {}),
                      (0, i.jsx)(W.FooterSlot, { children: g }),
                    ],
                  }),
              ],
            });
...
`,
        Di = ({ progress: a = 0, variant: r = 'common', ...e }) =>
          (0, i.jsxs)('progress', {
            ...e,
            'arc-progress-bar': '',
            'data-variant': r,
...
`,
        Yi = y(Y, ['common', 'ai', 'critical']),
        Xi = ['default', 'success', 'warning', 'error'],
        qi = y(G, ['inherit', 'md']),
        Wi = y(Y, ['common']),
        Gi = y(sa, ['', 'auto', 'manual']),
        Ki = [
              ...
              children: (0, i.jsxs)('div', {
                ...
                children: [
                  (0, i.jsxs)('div', {
                    'arc-toast-body': '',
                    children: [
                      e && (0, i.jsx)(j, { icon: e, 'arc-toast-icon': '' }),
                      (0, i.jsx)('div', {
                        'arc-toast-content': '',
                        children:
                          r ||
                  ...
                  x &&
                    (0, i.jsx)(Di, {
                      ...x,
                      variant: z === 'error' ? 'critical' : x.variant,
                      'arc-toast-progress-bar': '',
                    }),
                ],
              }),
      ...
      ((Ne.handleToast = Qi), _('ArcToast', Zi));
      const rn = (a, r = 1 / 0, e = ' ') =>
        [...a].flat(r)?.filter(Boolean)?.join(e);
    },
  },
]);
