            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl">
              {navItems.map((item, i) => (
                <a
                  ...
                  className="block px-4 py-3 text-center font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors first:rounded-t-2xl last:rounded-b-2xl"
                >
                  {item.label}
                </a>
              ))}
